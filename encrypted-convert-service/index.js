...
import  convertRouter  from "./routes/convertAuth.js"; // Import the conversion route
...
app.use((req, res, next) => {
  res.header('Access-Control-Allow-Origin', 'https://rapidford-6.onrender.com');
...
app.use("/convert-auth", convertRouter);

const port = process.env.PORT || 5004; // You can change the port number if needed
